...
const ProfileMain = ({ navigation }) => {
  ...
  const getData = async () => {
    console.log("\n","getData")
    // console.log("profile_data.user.id",profile_data.user.id, Platform.OS)
    await axios
      ...
      .then((resp) => {
        ...
        if (status_code == 200) {
          ...
          console.log("profile_data",profile_data.userpreferances)
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      console.log("profile_data ue",profile_data.userpreferances)
